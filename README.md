...
| Tag push | Preflight + builds + integration labs + GitHub Release | ~4 hours |
...
4. **Integration lab** (planned): 3 distros x 2 provisioners x 4 compute nodes (BIOS/UEFI, stateless/stateful)
5. **Upload to GitHub Release** (planned): attaches all RPM/DEB packages
