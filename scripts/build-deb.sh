...
package_name=${OPENCATTUS_DEB_PACKAGE_NAME:-opencattus}
...
Breaks: opencattus-installer (<= 1.0-1), opencattus-installer-debug (<= 1.0-6)
Replaces: opencattus-installer (<= 1.0-1), opencattus-installer-debug (<= 1.0-6)
