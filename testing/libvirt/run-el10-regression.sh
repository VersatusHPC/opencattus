...
HARNESS="${SCRIPT_DIR}/opencattus-el10-lab.sh"

readonly SCRIPT_DIR
readonly HARNESS

JOBS=1
LOG_ROOT=${LOG_ROOT:-/var/tmp/opencattus-el10-regression}

usage() {
    cat <<'EOF'
Usage:
  run-el10-regression.sh [-j jobs] ENVFILE [ENVFILE...]

Run one or more prepared EL10 libvirt lab configs through the shared harness and
...
Logs:
  ...
  /var/tmp/opencattus-el10-regression/<timestamp>/ by default. Override
