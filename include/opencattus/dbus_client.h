...
#ifndef OPENCATTUS_DBUS_CLIENT_H_
#define OPENCATTUS_DBUS_CLIENT_H_
...
using opencattus::services::MessageBus;
using opencattus::services::MessageBusMethod;
using opencattus::services::MessageReply;
using opencattus::services::MethodParamVariant;
