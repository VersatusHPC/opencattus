...
#ifndef OPENCATTUS_DISKIMAGE_H_
#define OPENCATTUS_DISKIMAGE_H_
...
private:
    ...
    std::optional<opencattus::models::OS::Distro> m_distro = std::nullopt;
...
public:
    ...
    [[nodiscard]] opencattus::models::OS::Distro getDistro() const;
