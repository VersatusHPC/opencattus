#ifndef OPENCATTUS_ANSIBLE_ROLE_H_
#define OPENCATTUS_ANSIBLE_ROLE_H_
...
template <> struct fmt::formatter<opencattus::services::ansible::roles::Role> {
    ...
    auto format(const opencattus::services::ansible::roles::Role& role,
        FormatContext& ctx)
    {
